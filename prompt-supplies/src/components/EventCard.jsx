    ...
    <>
      <div className="h-full flex justify-center items-center">
        <div
          ...
          style={{ backgroundImage: `url('https://loremflickr.com/640/360')` }}
        >
          <div className="flex justify-between items-center ml-4 pr-8">
            ...
            <div className="bg-red-600 w-20 h-16 shadow flex flex-col-reverse p-2 text-center font-bold text-white rounded-b-full">
              %
            </div>
          </div>
